...
public class MemberServiceimpl implements MemberService {
    ...
    public Member selByMphone(String  mphone) {
        return memberDao.selByMphone(mphone);
    }

    public Integer selByMphonecount(String mphone) {
        return memberDao.selByMphonecount(mphone);
    }
