...
public class ClassOrderServiceImpl implements ClassOrderService {
    ...
    public List<ClassOrder> selmemOrderById(int coid) {
        return classOrderDao.selmemOrderById(coid);
    }

    public Boolean upClassnumber(Integer conum, int classnumber){
        return classOrderDao.upClassnumber(conum,classnumber);
    }
